...
$epicJson = br create "Phase 2: Bidirectional sync and state tracking" -t epic -p 0 -d "Add SQLite tracking DB, update detection, and resolution handling" --json | ConvertFrom-Json
$EPIC_ID = $epicJson.id
...
Write-Host "First task: br show $DB_ID"